...
const MATRIX: MatrixEntry[] = [
  ...
  },
  {
    ...
    route: '/api/admin/settings/mail',
    path: () => '/api/admin/settings/mail',
    // Leerer Host/Absender = Mailversand bewusst deaktiviert, kein echter Verbindungsversuch
  ...
  {
    method: 'POST',
    route: '/api/admin/settings/mail/test',
  ...
  {
    method: 'PATCH',
    route: '/api/admin/settings/mail-templates/[key]',
  ...
  {
    method: 'POST',
    route: '/api/admin/settings/mail-templates/[key]/preview',
