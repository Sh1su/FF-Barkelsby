...
const DEMO = [
  ...
  },
  {
    ...
    location: 'Atemschutzstrecke Kreisfeuerwehrverband',
    capacity: 8,
    motif: 1,
  },
  {
  ...
  },
  {
    ...
    category: 'fuehrung-organisation',
    format: 'kreisausbildung',
    offset: 35,
    days: 2,
    timeLabel: '08:30 – 16:30',
    location: 'Kreisfeuerwehrzentrale',
    capacity: 10,
    motif: 6,
  },
  {
...
test('Bildstrecke für die QA', async ({ page }) => {
  ...
  const instructor = await (await page.request.post('/api/admin/instructors', {
    headers: { cookie },
    data: {
      name: 'Oberbrandmeisterin Vogt',
      role: 'Ausbilderin Grundausbildung',
      vita: 'Seit 2009 in der Wehr, seit 2016 Ausbilderin auf Kreisebene.',
    },
  })).json()
